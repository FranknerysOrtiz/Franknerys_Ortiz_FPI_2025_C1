...
void Lectura(int A[][C][P], int FI, int CO, int PR)
{
    ...
    for(J=0; J<CO;J++);
    {
        printf("Año: %d\tCarrera: %\tSemestre; %d ", K+1, I+1, J+1);
        scanf("%d", &A[I][J][K]);
    }
}
void Funcion1(int A[][C][P], int FI, int CO, int PR)
{
    ...
    printf("\n\nAño con mayor ingreso de alumnos:%d", AO+1, MAY);
...
void Fucion3(int A[][P], int FI, int CO, int PR)
{
    ...
    printf("\n\nA;o con mayor ingreso de alumno: %d", AO+1, MAY);
}
