...
void main (void)
{
    ...
    strcpy(cad1, cad0);
    printf("\nPrueba de la funcion strpy. Se copia la cadena cad0 a cad1: %s\n", cad1);
    ...
    strncpy(cad2, cad0, 4);
    cad2[4] = '\0';
    printf("\nPrueba de la función strcpy. Se copian 4 caracteres de cad0 a cad2: %s\n", cad2);

    strncpy(cad2, cad3, 3);
    cad2[3] = '\0';
    printf("\nPrueba de la función strcpy. Se copian 3 caracteres de cad3 a cad2: %s\n", cad2);
    ...
    strcat(cad0, cad3);
     ...
     strcat(cad1, "YY");
      printf("\nPrueba de la función strcat. Se incorpora la cadena YY a cad1: s\n", cad1);
       ...
       strcat(cad2, "");
        strncat(cad2, cad0, 4);
        printf("\nPrueba de la función strcat. Se incorpora 4 caracteres  de cad0 a cad2: s\n", cad2);
